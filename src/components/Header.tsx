...
interface HeaderProps {
  ...
  activeScreenMode: 'tour' | 'gallery' | 'specs' | 'artisan';
  onSelectScreenMode: (mode: 'tour' | 'gallery' | 'specs' | 'artisan') => void;
    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#111319]/90 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.6)] border-b border-[#45464f]/30">
      <div className="h-20 w-full px-3 sm:px-6 lg:px-8 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <nav className="flex items-center gap-1 bg-[#0c0e14]/80 p-1 rounded-xl border border-[#45464f]/40">
            <button
              onClick={() => {
                onSelectScreenMode('tour');
                soundFx.playClick();
              }}
              className={`px-3 py-1.5 text-xs font-space font-semibold rounded-lg transition-all flex items-center gap-1.5 ${
            ...
            >
              ...
              <span className="hidden md:inline">Tour 3D</span>
            </button>
            ...
            >
              ...
              <span className="hidden md:inline">Pantallas & Ángulos</span>
            </button>
          ...
          {activeScreenMode === 'tour' && (
            <div className="hidden 2xl:flex items-center gap-1 bg-[#0c0e14]/80 p-1 rounded-xl border border-[#45464f]/30">
              {[
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            onClick={toggleSound}
            className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#282a30]/80 border border-[#45464f]/40 flex items-center justify-center transition-all ${
              isAudioActive
          ...
          <button
            ...
            className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#282a30]/80 border border-[#45464f]/40 flex items-center justify-center text-[#c6c5d0] hover:text-[#e2e2eb] hover:bg-[#33343b] transition-all"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[#1e2b58] text-[#b8c4fb] hover:bg-[#212e5b] hover:text-[#ffffff] border border-[#b8c4fb]/40 text-xs font-space font-semibold transition-all shadow-[0_0_16px_rgba(30,43,88,0.4)]"
          >
            <span className="material-symbols-outlined text-[17px]">architecture</span>
            <span className="hidden sm:inline">Ficha Técnica Xente</span>
          </button>
        </div>
      </div>
    </header>
